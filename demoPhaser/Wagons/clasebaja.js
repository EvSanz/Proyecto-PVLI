...
export default class ClaseBaja extends Wagon {
  ...
  spawnNPCs(){
   ...
   this.npc=new Npc(this, 160, 238, 1, this.scene.get('boot').dmanager.npcinfoholder[0].anger, 9, 1);
   this.npc2=new Npc(this, 390, 238, 2, this.scene.get('boot').dmanager.npcinfoholder[7].anger, 22, 3);
